...
def gray_to_rgb_emb(gray_img):
    ...
    # color = [[255, 255, 255], [255, 255, 255], [255, 255, 255], [255, 255, 255], [255, 255, 255], [255, 255, 255]]
    for i in range(len(element)):
        rbg_emb[gray_img == element[i]] = color[i]
    return rbg_emb/255


def process_instance_embedding(instance_embedding, binary_img, distance=1, lane_num=1):
